...
export default class Mahmood extends Component{
  render(){
    return(
      <ScrollView style = {SharedStyles.container}>
      <View>
        <Text style={SharedStyles.heading2}>Name</Text><Text style = {SharedStyles.doctorInfo}>Dr. Mahmood Aahamood Khan</Text>
      </View>
      <View>
      ...
      <View>
        <Text style={SharedStyles.heading2}>NMC Registration</Text><Text style = {SharedStyles.doctorInfo}>13910</Text>
      </View>
      <View>
      ...
      <View>
        <Text style={SharedStyles.heading2}>Remarks</Text><Text style = {SharedStyles.doctorInfo}>Mahendranagar Branch</Text>
      </View>
      </ScrollView>
    )
  }

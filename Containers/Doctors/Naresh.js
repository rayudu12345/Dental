...
export default class Naresh extends Component{
  render(){
    return(
      ...
      <View>
        <Text style={SharedStyles.heading2}>Name</Text><Text style = {SharedStyles.doctorInfo}>Dr. Naresh Joshi</Text>
      </View>
      <View>
      ...
      <View>
        <Text style={SharedStyles.heading2}>Remarks</Text><Text style = {SharedStyles.doctorInfo}>Dhangadi Branch</Text>
      </View>
      </ScrollView>
    )
  }

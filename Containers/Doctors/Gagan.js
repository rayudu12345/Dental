...
export default class Gagan extends Component{
  render(){
    return(
      ...
      <View>
        <Text style={SharedStyles.heading2}>Name</Text><Text style = {SharedStyles.doctorInfo}>Dr. Gagan Khanal</Text>
      </View>
      <View>
      ...
      <View>
        <Text style={SharedStyles.heading2}>NMC Registration</Text><Text style = {SharedStyles.doctorInfo}>5328</Text>
      </View>
      <View>
